...
screen about():
    ...
    use game_menu(_("Tentang"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Dibuat Dengan {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t] \n\nTim RPL - SMKN4PLG - NEET, yang terdiri dari Nugraha Abi Santana, M. Apriansyah, M. Izzat Al Fawwaz, Muhammad Tohir Arsyad Romadhon, Badiatul Roziqin, dan Prana Sakti, berhasil menciptakan sebuah game dalam ajang Gameseed 2024")
